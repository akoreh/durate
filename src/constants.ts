...
export const unitMap: Record<string, number> = Object.assign(Object.create(null), {
  ms: 1, millisecond: 1, milliseconds: 1, msec: 1, msecs: 1,
  s, second: s, seconds: s, sec: s, secs: s,
  m, minute: m, minutes: m, min: m, mins: m,
  h, hour: h, hours: h, hr: h, hrs: h,
  d, day: d, days: d,
  w, week: w, weeks: w,
  mo, month: mo, months: mo, mon: mo, mons: mo,
  y, year: y, years: y, yr: y, yrs: y,
});
